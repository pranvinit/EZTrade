...
import { Instagram, YouTube, Twitter, GitHub } from '@material-ui/icons';
        ...
        <div id={styles.mainFooter}>
            ...
            <div id={styles.socialsContainer}>
                <ul id={styles.socialsUl}>
                    <a href="https://github.com/pranvinit">
                        <li><GitHub className={`${styles.gh} ${styles.socials}`} fontSize="medium" /></li>
                    </a>
